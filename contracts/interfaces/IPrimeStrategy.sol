...
error VAULT__ZERO_AMOUNT();

error VAULT__ZERO_ADDRESS();

error VAULT__INVALID_DEPOSIT_TOKEN();

error  VAULT__TOKEN_NOT_ALLOWED();

error  VAULT__TOKEN_ALREADY_ALLOWED();
...
event HarvestFailed(bytes32 key,bytes reason);
